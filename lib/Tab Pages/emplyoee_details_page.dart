                ...
                children: [
                  Expanded(
                    child: Padding(
                      padding: const EdgeInsets.only(right: 144),
                      child:
                          titleTextField("Designation", designationController),
                    ),
                  ),
                  Expanded(
                    child: Padding(
                    ...
                    function: () async {
                      ...
                      await post(url, body: jsonEncode(body)).then((value) {
                        ...
                        if (value.body.toString() == "done") {
                          ...
                          showSnackbar(
                              context, "Unknown Error Occur", Colors.red);
                        }
                      });
                    },
                    left: 0,
  ...
  DataRow _getDataRow(index) {
    return DataRow(
      cells: <DataCell>[
        ...
        DataCell(Text("${name[index]}"), showEditIcon: false, onTap: () {
          showUpdateDialog(index, "Name");
        }),
        DataCell(Text("${address[index]}"), showEditIcon: false, onTap: () {
          showUpdateDialog(index, "Address");
        }),
        DataCell(Text("${phoneNumber[index]}"), showEditIcon: false, onTap: () {
          showUpdateDialog(index, "Phone Number");
        }),
        DataCell(Text("${email[index]}"), showEditIcon: false, onTap: () {
          showUpdateDialog(index, "Email");
        }),
        DataCell(Text("${designation[index]}"), showEditIcon: false, onTap: () {
